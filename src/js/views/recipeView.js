...
class RecipeView extends View {
  ...
  addHandlerRender(handler) {
    // Hashchange is trigged by clicking a hyperlink - thus a URL change
    // We need to controlRecipes on page load and on hashchange:
  ...
  addHandlerUpdateServings(handler) {
    this._parentElement.addEventListener("click", function (e) {
      ...
      if (!btn) return;
      const updateTo = +btn.dataset.updateTo; // dash in property name converted to camelCase automatically
